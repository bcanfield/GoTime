  ...
  return (
    <div className="dropdown">
      <div
        ...
        tabIndex={0}
        role="button"
        className="link link-hover text-base-content/60 inline-block font-mono text-[0.625rem]"
      >
        5.0.9{" "}
        <svg
          className="text-base-content/60 -mt-0.25 hidden size-2 fill-current sm:inline-block"
      ...
      <ul
        tabIndex={0}
        className="dropdown-content menu menu-sm bg-base-200 rounded-box mt-7 w-36 border border-white/5 p-2 shadow-2xl outline-1 outline-black/5"
      >
        <li>
          <a href="/docs/v5/">
            <svg
            ...
            >
              <g fill="currentColor">
                ...
                <clipPath id="1733501816477-2951362_b">
                  <use
                    xlinkHref="#1733501816477-2951362_a"
                    overflow="visible"
                  ></use>
                </clipPath>
                <path
