...
function RouteComponent() {
  const markdown = `# How to Play Go – Official Resources & Our Implementation

For a complete, official introduction to the game of Go, we recommend reviewing these authoritative resources:
- [Sensei's Library – Go Rules](https://senseis.xmp.net/?GoRules)
- [American Go Association – Official Rules](https://www.usgo.org/rules)
- [The Interactive Way To Go](https://www.theworldofgo.net/)
...
Enjoy your game and happy playing!
`;
